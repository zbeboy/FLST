...
@Repository
public class FriendlyLinkDao extends DAOImpl<FriendlyLinkRecord, cn.edu.kmust.flst.domain.public_.tables.pojos.FriendlyLink, String> {

    /**
     * Create a new FriendlyLinkDao without any configuration
     */
    public FriendlyLinkDao() {
        super(FriendlyLink.FRIENDLY_LINK, cn.edu.kmust.flst.domain.public_.tables.pojos.FriendlyLink.class);
    }
    ...
    public FriendlyLinkDao(Configuration configuration) {
        super(FriendlyLink.FRIENDLY_LINK, cn.edu.kmust.flst.domain.public_.tables.pojos.FriendlyLink.class, configuration);
    }
     ...
     */
    @Override
    protected String getId(cn.edu.kmust.flst.domain.public_.tables.pojos.FriendlyLink object) {
