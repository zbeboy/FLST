...
public class Article extends TableImpl<ArticleRecord> {
    ...
    private static final long serialVersionUID = 1114606115;
     ...
     */
    public final TableField<ArticleRecord, String> ARTICLE_BRIEF = createField("article_brief", org.jooq.impl.SQLDataType.VARCHAR(100), this, "");
    ...
    /**
     * The column <code>flst.article.article_content</code>.
     */
    public final TableField<ArticleRecord, String> ARTICLE_CONTENT = createField("article_content", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ARTICLE_PRIMARY, Indexes.ARTICLE_USERNAME);
    }
