...
@Repository
public class UsersDao extends DAOImpl<UsersRecord, cn.edu.kmust.flst.domain.public_.tables.pojos.Users, String> {

    /**
     * Create a new UsersDao without any configuration
     */
    public UsersDao() {
        super(Users.USERS, cn.edu.kmust.flst.domain.public_.tables.pojos.Users.class);
    }
    ...
    public UsersDao(Configuration configuration) {
        super(Users.USERS, cn.edu.kmust.flst.domain.public_.tables.pojos.Users.class, configuration);
    }
     ...
     */
    @Override
    protected String getId(cn.edu.kmust.flst.domain.public_.tables.pojos.Users object) {
