...
public class AuthoritiesRecord extends UpdatableRecordImpl<AuthoritiesRecord> implements Record2<String, String> {
    ...
    private static final long serialVersionUID = 1408923665;

    /**
     * Setter for <code>flst.authorities.username</code>.
     */
    ...
    /**
     * Getter for <code>flst.authorities.username</code>.
     */
    @NotNull
    @Size(max = 64)
    ...
    /**
     * Setter for <code>flst.authorities.authority</code>.
     */
    ...
    /**
     * Getter for <code>flst.authorities.authority</code>.
     */
    @NotNull
    @Size(max = 50)
