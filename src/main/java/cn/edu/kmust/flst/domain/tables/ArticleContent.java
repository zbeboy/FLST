...
public class ArticleContent extends TableImpl<ArticleContentRecord> {
    ...
    private static final long serialVersionUID = 1558428333;
     ...
     */
    public final TableField<ArticleContentRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
