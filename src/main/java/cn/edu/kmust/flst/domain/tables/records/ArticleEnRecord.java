...
public class ArticleEnRecord extends UpdatableRecordImpl<ArticleEnRecord> implements Record11<Integer, String, String, String, Timestamp, Integer, String, Integer, String, String, String> {
    ...
    private static final long serialVersionUID = -1617748261;
     ...
     */
    public ArticleEnRecord(Integer articleId, String articleTitle, String articleBrief, String articleCover, Timestamp articleDate, Integer articleClicks, String username, Integer articleSources, String articleSourcesName, String articleSourcesLink, String menuId) {
        super(ArticleEn.ARTICLE_EN);
