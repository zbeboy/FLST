...
public class Banner extends TableImpl<BannerRecord> {
    ...
    private static final long serialVersionUID = 508381560;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.BANNER_BANNER_CREATOR, Indexes.BANNER_MENU_ID, Indexes.BANNER_PRIMARY);
    }
