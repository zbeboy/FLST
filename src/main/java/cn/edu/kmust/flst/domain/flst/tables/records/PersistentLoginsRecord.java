...
public class PersistentLoginsRecord extends UpdatableRecordImpl<PersistentLoginsRecord> implements Record4<String, String, String, Timestamp> {
    ...
    private static final long serialVersionUID = 1419545194;
    ...
    /**
     * Getter for <code>FLST.PERSISTENT_LOGINS.USERNAME</code>.
     */
    @NotNull
    @Size(max = 64)
    ...
    /**
     * Setter for <code>FLST.PERSISTENT_LOGINS.SERIES</code>.
     */
    ...
    /**
     * Getter for <code>FLST.PERSISTENT_LOGINS.SERIES</code>.
     */
    @NotNull
    @Size(max = 64)
    ...
    /**
     * Setter for <code>FLST.PERSISTENT_LOGINS.TOKEN</code>.
     */
    ...
    /**
     * Getter for <code>FLST.PERSISTENT_LOGINS.TOKEN</code>.
     */
    @NotNull
    @Size(max = 64)
    ...
    /**
     * Setter for <code>FLST.PERSISTENT_LOGINS.LAST_USED</code>.
     */
