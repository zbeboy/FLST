...
public class FriendlyLink extends TableImpl<FriendlyLinkRecord> {
    ...
    private static final long serialVersionUID = 2052082434;
     ...
     */
    public final TableField<FriendlyLinkRecord, Byte> LINK_SHOW = createField("link_show", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("1", org.jooq.impl.SQLDataType.TINYINT)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.FRIENDLY_LINK_PRIMARY);
    }
    ...
    public UniqueKey<FriendlyLinkRecord> getPrimaryKey() {
        return Keys.KEY_FRIENDLY_LINK_PRIMARY;
    }
    ...
    public List<UniqueKey<FriendlyLinkRecord>> getKeys() {
        return Arrays.<UniqueKey<FriendlyLinkRecord>>asList(Keys.KEY_FRIENDLY_LINK_PRIMARY);
    }
