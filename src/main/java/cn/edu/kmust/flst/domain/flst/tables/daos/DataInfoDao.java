...
@Repository
public class DataInfoDao extends DAOImpl<DataInfoRecord, cn.edu.kmust.flst.domain.flst.tables.pojos.DataInfo, String> {

    /**
     * Create a new DataInfoDao without any configuration
     */
    public DataInfoDao() {
        super(DataInfo.DATA_INFO, cn.edu.kmust.flst.domain.flst.tables.pojos.DataInfo.class);
    }
    ...
    public DataInfoDao(Configuration configuration) {
        super(DataInfo.DATA_INFO, cn.edu.kmust.flst.domain.flst.tables.pojos.DataInfo.class, configuration);
    }
     ...
     */
    @Override
    protected String getId(cn.edu.kmust.flst.domain.flst.tables.pojos.DataInfo object) {
     ...
     */
    public List<cn.edu.kmust.flst.domain.flst.tables.pojos.DataInfo> fetchByDataKey(String... values) {
     ...
     */
    public cn.edu.kmust.flst.domain.flst.tables.pojos.DataInfo fetchOneByDataKey(String value) {
     ...
     */
    public List<cn.edu.kmust.flst.domain.flst.tables.pojos.DataInfo> fetchByDataValue(String... values) {
