...
@Repository
public class PersistentLoginsDao extends DAOImpl<PersistentLoginsRecord, cn.edu.kmust.flst.domain.tables.pojos.PersistentLogins, String> {

    /**
     * Create a new PersistentLoginsDao without any configuration
     */
    public PersistentLoginsDao() {
        super(PersistentLogins.PERSISTENT_LOGINS, cn.edu.kmust.flst.domain.tables.pojos.PersistentLogins.class);
    }
    ...
    public PersistentLoginsDao(Configuration configuration) {
        super(PersistentLogins.PERSISTENT_LOGINS, cn.edu.kmust.flst.domain.tables.pojos.PersistentLogins.class, configuration);
    }
     ...
     */
    @Override
    protected String getId(cn.edu.kmust.flst.domain.tables.pojos.PersistentLogins object) {
     ...
     */
    public List<cn.edu.kmust.flst.domain.tables.pojos.PersistentLogins> fetchByUsername(String... values) {
     ...
     */
    public List<cn.edu.kmust.flst.domain.tables.pojos.PersistentLogins> fetchBySeries(String... values) {
     ...
     */
    public cn.edu.kmust.flst.domain.tables.pojos.PersistentLogins fetchOneBySeries(String value) {
     ...
     */
    public List<cn.edu.kmust.flst.domain.tables.pojos.PersistentLogins> fetchByToken(String... values) {
     ...
     */
    public List<cn.edu.kmust.flst.domain.tables.pojos.PersistentLogins> fetchByLastUsed(Timestamp... values) {
