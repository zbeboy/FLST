...
public class FilesRecord extends UpdatableRecordImpl<FilesRecord> implements Record7<String, String, String, String, String, String, Timestamp> {

    private static final long serialVersionUID = -1341515011;
     ...
     */
    @Override
    public FilesRecord values(String value1, String value2, String value3, String value4, String value5, String value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public FilesRecord(String fileId, String size, String originalFileName, String newName, String relativePath, String ext, Timestamp uploadDate) {
        super(Files.FILES);
